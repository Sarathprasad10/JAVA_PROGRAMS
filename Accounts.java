...
public class Accounts {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter Details  for Account[account holder name, account number, and initial amount for account 1]:");
        ...
        System.out.println("Enter Details  for Account[account holder name, account number,Address,Account Type and Balancee amount for account 2]:");
        ...
        System.out.println("Account 1 is balance: $" + account1.getBalance());
        System.out.println("Account 2 is balance: $" + account2.getBalance());
        scanner.close();
    }
}
